...
if /I "%~1"=="--dry-run" (
  ...
  echo [DRY-RUN] readiness max age: 120 seconds
  echo [DRY-RUN] 3. classify checks into sensor_bridge, fast_lio, mavros, ego_swarm, flight_gate
  echo [DRY-RUN] 4. write $STAGE7_RUN_DIR/topic_probe_report.json
