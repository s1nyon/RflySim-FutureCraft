...
if not defined COMPETITION_COURSE_V2_POS_X_STR set COMPETITION_COURSE_V2_POS_X_STR=-0.7,0.7
if not defined COMPETITION_COURSE_V2_POS_Y_STR set COMPETITION_COURSE_V2_POS_Y_STR=2,2
if not defined COMPETITION_COURSE_V2_YAW_STR set COMPETITION_COURSE_V2_YAW_STR=90,90
