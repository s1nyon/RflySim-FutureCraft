...
- 不安装 UE Editor：地图问题已用 SLAMScene + 动态砖块方案临时解决并 live 验证通过，禁止反复询问“是否装 UE”；若未来确需 UE 静态地图，由用户主动提出并先确认 UE4 Editor 可用性（见 `docs/decisions/2026-08-07-no-ue-editor.md`）。
